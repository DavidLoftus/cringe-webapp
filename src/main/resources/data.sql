...
INSERT INTO GAMES(TITLE, DESCRIPTION, RELEASE_ID, ICON_ID, LOGO_ID, BANNER_ID, PRICE) VALUES ('Doom', 'DOOM returns as a brutally fun and challenging modern-day shooter experience. Relentless demons, impossibly destructive guns, and fast, fluid movement provide the foundation for intense, first-person combat – whether you’re obliterating demon hordes through the depths of Hell in the single-player campaign, or competing against your friends in numerous multiplayer modes. Expand your gameplay experience using DOOM SnapMap game editor to easily create, play, and share your content with the world.', 1, 2, 13, 14, 30);
...
INSERT INTO GAMES(TITLE, DESCRIPTION, RELEASE_ID, ICON_ID, PRICE) VALUES ('Ms Pacman', 'Woah they even got my boi pacman.', 3, 4, 4.99);
...
INSERT INTO GAMES(TITLE, DESCRIPTION, RELEASE_ID, ICON_ID, BANNER_ID, LOGO_ID, BACKGROUND_ID, PRICE)
    VALUES (
            'Grand Theft Auto',
...
INSERT INTO GAMES(TITLE, DESCRIPTION, RELEASE_ID, ICON_ID, BANNER_ID, PRICE) VALUES ('Call of Duty', 'Welcome to 2065. A new breed of Black Ops soldier emerges and the lines are blurred between our own humanity and the cutting-edge military robotics that define the future of combat.', 7, 8, 12, 50);
